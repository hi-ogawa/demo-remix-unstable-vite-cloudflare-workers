...
function defineConventionalRoutes(appDir, ignoredFilePatterns) {
  ...
  function defineNestedRoutes(defineRoute, parentId) {
    ...
    for (let routeId of childRouteIds) {
      ...
      let isPathlessLayoutRoute = ((_routeId$split$pop = routeId.split("/").pop()) === null || _routeId$split$pop === void 0 ? void 0 : _routeId$split$pop.startsWith("__")) === true;
